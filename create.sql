...
#CREATE SCHEMA IF NOT EXISTS `drycleaning` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ;
#USE `drycleaning` ;
...
-- -----------------------------------------------------
-- Table `drycleaning`.`CUSTOMER_DATA`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `drycleaning`.`CUSTOMER_DATA` (
...
-- -----------------------------------------------------
-- Table `drycleaning`.`PHONE`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `drycleaning`.`PHONE` (
...
-- -----------------------------------------------------
-- Table `drycleaning`.`EMAIL`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `drycleaning`.`EMAIL` (
...
-- -----------------------------------------------------
-- Table `drycleaning`.`ORDER_DATA`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `drycleaning`.`ORDER_DATA` (
  ...
  CONSTRAINT `fk_ORDER_DATA_CUSTOMER_DATA1`
    ...
    REFERENCES `drycleaning`.`CUSTOMER_DATA` (`idCustomer` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `drycleaning`.`ORDER_ITEM_DATA`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `drycleaning`.`ORDER_ITEM_DATA` (
  ...
  CONSTRAINT `fk_ORDER_ITEM_DATA_ORDER_DATA1`
    ...
    REFERENCES `drycleaning`.`ORDER_DATA` (`OrderNumber` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `drycleaning`.`SERVICE_DATA`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `drycleaning`.`SERVICE_DATA` (
...
-- -----------------------------------------------------
-- Table `drycleaning`.`ORDER_ITEM_DATA_has_SERVICE_DATA`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `drycleaning`.`ORDER_ITEM_DATA_has_SERVICE_DATA` (
  ...
  CONSTRAINT `fk_ORDER_ITEM_DATA_has_SERVICE_DATA_ORDER_ITEM_DATA`
    ...
    REFERENCES `drycleaning`.`ORDER_ITEM_DATA` (`idOrderItem` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ORDER_ITEM_DATA_has_SERVICE_DATA_SERVICE_DATA1`
    FOREIGN KEY (`SERVICE_DATA_idService` )
    REFERENCES `drycleaning`.`SERVICE_DATA` (`idService` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `drycleaning`.`CUSTOMER_DATA_has_PHONE`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `drycleaning`.`CUSTOMER_DATA_has_PHONE` (
  `CUSTOMER_DATA_idCustomer` BIGINT NOT NULL ,
  ...
  CONSTRAINT `fk_CUSTOMER_DATA_has_PHONE_PHONE1`
    ...
    REFERENCES `drycleaning`.`PHONE` (`idPhone` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `drycleaning`.`CUSTOMER_DATA_has_EMAIL`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `drycleaning`.`CUSTOMER_DATA_has_EMAIL` (
  `CUSTOMER_DATA_idCustomer` BIGINT NOT NULL ,
  ...
  CONSTRAINT `fk_CUSTOMER_DATA_has_EMAIL_EMAIL1`
    ...
    REFERENCES `drycleaning`.`EMAIL` (`idEmail` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
